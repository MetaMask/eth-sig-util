...
- revert: un-release 9.0.0 ([#423](https://github.com/MetaMask/eth-sig-util/pull/423))
- 9.0.0 ([#420](https://github.com/MetaMask/eth-sig-util/pull/420))
- chore: add workflow_dispatch to security-code-scanner ([#411](https://github.com/MetaMask/eth-sig-util/pull/411))
...
- **BREAKING**: Bump `@metamask/abi-utils` from `^1.0.2` to `^2.0.2` ([#326](https://github.com/MetaMask/eth-sig-util/pull/326))
...
- Remove unused dependency `bn.js` ([#302](https://github.com/MetaMask/eth-sig-util/pull/302), [#334](https://github.com/MetaMask/eth-sig-util/pull/334))
