...
test('unbound sign typed data utility functions', (t) => {
  ...
  t.equal(
    encodeType('Person', typedData.types),
    'Person(string name,Person mother,Person father)',
  );

  t.equal(
    ethUtil.bufferToHex(hashType('Person', typedData.types)),
    '0x7c5c8e90cb92c8da53b893b24962513be98afcf1b57b00327ae4cc14e3a64116',
  );

  t.equal(
    ethUtil.bufferToHex(
      encodeData('Person', typedData.message.mother, typedData.types),
    ),
    `0x${[
      '7c5c8e90cb92c8da53b893b24962513be98afcf1b57b00327ae4cc14e3a64116',
      'afe4142a2b3e7b0503b44951e6030e0e2c5000ef83c61857e2e6003e7aef8570',
  ...
  t.equal(
    ethUtil.bufferToHex(
      hashStruct('Person', typedData.message.mother, typedData.types),
    ),
    '0x9ebcfbf94f349de50bcb1e3aa4f1eb38824457c99914fefda27dcf9f99f6178b',
  );
  ...
  t.equal(
    ethUtil.bufferToHex(
      encodeData('Person', typedData.message.father, typedData.types),
    ),
    `0x${[
      '7c5c8e90cb92c8da53b893b24962513be98afcf1b57b00327ae4cc14e3a64116',
      'b2a7c7faba769181e578a391a6a6811a3e84080c6a3770a0bf8a856dfa79d333',
  ...
  t.equal(
    ethUtil.bufferToHex(
      hashStruct('Person', typedData.message.father, typedData.types),
    ),
    '0xb852e5abfeff916a30cb940c4e24c43cfb5aeb0fa8318bdb10dd2ed15c8c70d8',
  );
  ...
  t.equal(
    ethUtil.bufferToHex(
      encodeData(typedData.primaryType, typedData.message, typedData.types),
    ),
    `0x${[
      '7c5c8e90cb92c8da53b893b24962513be98afcf1b57b00327ae4cc14e3a64116',
      'e8d55aa98b6b411f04dbcf9b23f29247bb0e335a6bc5368220032fdcb9e5927f',
  ...
  t.equal(
    ethUtil.bufferToHex(eip712Hash(typedData)),
    '0x807773b9faa9879d4971b43856c4d60c2da15c6f8c062bd9d33afefb756de19c',
  );
});
