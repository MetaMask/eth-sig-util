...
module.exports = {
    ...
    decrypt: function (encryptedData, receiverPrivateKey) {
        switch (encryptedData.version) {
            case "x25519-xsalsa20-poly1305":
                ...
                var recieverEncryptionPrivateKey = nacl.box.keyPair.fromSecretKey(
                ...
                var ephemPublicKey = naclUtil.decodeBase64(
                    encryptedData.ephemPublicKey
                );

                // decrypt
                var decryptedMessage = nacl.box.open(
                    ciphertext,
                    nonce,
                    ephemPublicKey,
    ...
    decryptSafely: function (encryptedData, receiverPrivateKey) {
        const dataWithPadding = JSON.parse(
            this.decrypt(encryptedData, receiverPrivateKey)
        );
    ...
    getEncryptionPublicKey: function (privateKey) {
        ...
        var encryptionPublicKey = nacl.box.keyPair.fromSecretKey(
